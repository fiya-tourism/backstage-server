              ...
              <table class="table" width="100%" id="datalist">
                ...
                <tbody>
                  <tr>
                    ...
                    <td>1</td>
                    <td><a href="javascript:;">公司介绍</a></td>
                    <td>单页模型</td>
                    <td>是</td>
                  ...
                  <tr>
                    ...
                    <td>2</td>
                    <td><a href="javascript:;">精彩专题</a></td>
                    <td>外部链接</td>
                    <td>是</td>
                  ...
                  <tr>
                    <td><input type="checkbox" name=""></td>
                    <td>3</td>
                    <td><a href="javascript:;">新闻中心</a></td>
                    <td>文章模型</td>
                    <td>是</td>
                    <td><input type="text" name="" value="1"></td>
                    <td>
                  ...
                  <tr>
                    <td><input type="checkbox" name=""></td>
                    <td>4</td>
                    <td><a href="javascript:;">公司新闻</a></td>
                    <td>文章模型</td>
                    <td>是</td>
                    <td><input type="text" name="" value="1"></td>
                    <td>
                  ...
                  <tr>
                    <td><input type="checkbox" name=""></td>
                    <td>5</td>
                    <td><a href="javascript:;">行业新闻</a></td>
                    <td>文章模型</td>
                    <td>是</td>
                    <td><input type="text" name="" value="1"></td>
                    <td>
                  ...
                  <tr>
                    <td><input type="checkbox" name=""></td>
                    <td>6</td>
                    <td><a href="javascript:;">产品展示</a></td>
                    <td>产品模型</td>
                    <td>是</td>
                    <td><input type="text" name="" value="1"></td>
                    <td>
                  ...
                  <tr>
                    <td><input type="checkbox" name=""></td>
                    <td>8</td>
                    <td><a href="javascript:;">工艺品类</a></td>
                    <td>产品模型</td>
                    <td>是</td>
                    <td><input type="text" name="" value="1"></td>
                    <td>
                  ...
                  <tr>
                    <td><input type="checkbox" name=""></td>
                    <td>9</td>
                    <td><a href="javascript:;">公司相册</a></td>
                    <td>图片模型</td>
                    <td>是</td>
                    <td><input type="text" name="" value="1"></td>
                    <td>
                  ...
                  <tr>
                    <td><input type="checkbox" name=""></td>
                    <td>10</td>
                    <td><a href="javascript:;">在线留言</a></td>
                    <td>外部链接</td>
                    <td>是</td>
                    <td><input type="text" name="" value="1"></td>
                    <td>
